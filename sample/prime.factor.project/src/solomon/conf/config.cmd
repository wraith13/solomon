...
@SET SOLOMON_MAIN_CMD=%~dp0..\..\..\..\..\cmd\main.cmd

@REM プロジェクト名(コンソールウィンドウのタイトルに表示されます)
@SET SOLOMON_TARGET_PROJECT=prime factor project(solomon sample project)
...
@REM 32bit Windows で動作している場合には x86 のみに限定
@IF /I "%PROCESSOR_ARCHITECTURE%" EQU "x86" SET SOLOMON_BUILD_CMD_LIST="release x86" "debug x86"
