...
@IF NOT EXIST "%SOLOMON_TARGET_CONFIG_CMD%" COLOR 0C&ECHO CONFIG-ERROR: 設定ファイル "%SOLOMON_TARGET_CONFIG_CMD%" が存在しません。&GOTO :EOF
...
@IF "" EQU "%SOLOMON_MAIN_CMD%" COLOR 0C&ECHO CONFIG-ERROR: SOLOMON_MAIN_CMD が指定されていません。設定を確認してください。&GOTO :EOF
@IF NOT EXIST "%SOLOMON_MAIN_CMD%" COLOR 0C&ECHO CONFIG-ERROR: "%SOLOMON_MAIN_CMD%" が見つかりません。設定を確認してください。&GOTO :EOF
